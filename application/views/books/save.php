...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark"><?php echo (isset($row)) ? 'Edit' : 'Add' ?> Books</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="dashboard">Home</a></li>
						<li class="breadcrumb-item"><a href="dishes">Books</a></li>
						<li class="breadcrumb-item active"><?php echo (isset($row)) ? 'Edit' : 'Add' ?> Books</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
										...
										<div class="form-group wrap_form">
											...
											<div class="clearfix">&nbsp;</div>
								             <div class="col-xs-12 col-md-8">
												...
												<textarea type="text" class="form-control" id="title" placeholder="Description"name="description" ><?php if (isset($row)) {
												echo $row->description;} ?></textarea>
											</div>

											
											<input type="hidden" class="form-control" id="title" placeholder="status"name="status" value="InProgress">

											<?php  $user_id=$this->session->userdata('user')->id;?>
											...
											<div class="col-xs-12 col-md-6">
												...
												<?php if (isset($row)) {
													echo '<img src="' . base_url() . 'uploads/' . $row->image . '" width="20">';
												} ?>
											</div>
											...
											<div class="col-xs-12 col-md-6" style="margin-top: 37px;">
...
<script>
	...
	$('#form_add_update').on("submit", function(e) {
		...
		if ($('#filename').val() != '') {
			formData.append("filename", document.getElementById('filename').files[]);
		}
		$.ajax({
			type: "POST",
